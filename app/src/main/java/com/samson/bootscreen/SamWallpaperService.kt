    ...
    inner class SamWallpaperEngine : Engine() {
        ...
        private fun spawnParticles() {
            ...
            particles.add(Particle(
                cx + cos(angle)*(w*0.12f), cy + sin(angle)*(w*0.12f),
                cos(angle)*speed, sin(angle)*speed, 1f,
        ...
        private fun draw() {
            ...
            try {
                ...
                for (i in 0 until 4) {
                    ...
                    ringPaint.alpha = (((sin(phase)+1f)/2f*0.25f+0.05f)*255).toInt()
                    canvas.drawCircle(cx,cy,w*(0.18f+i*0.12f)+sin(t*0.5f+i)*w*0.02f,ringPaint)
                }
